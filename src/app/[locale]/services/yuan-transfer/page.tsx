...
const pageContent = {
  title: "حواله یوآن چین | علی‌پی و پرداخت به تامین‌کننده چینی",
  description: "بررسی حواله یوآن چین برای علی‌پی، خرید از چین، ارز دانشجویی، پرداخت به تامین‌کننده چینی و هماهنگی تسویه‌های تجاری مرتبط با واردات.",
  eyebrow: "پرداخت تجاری چین",
  heading: "حواله یوآن چین",
  lead: "برای خرید از چین، پرداخت علی‌پی، ارز دانشجویی یا تسویه تامین‌کننده چینی، زمان پرداخت و شفاف بودن مسیر انتقال پول مهم است. درخواست حواله یوآن بر اساس مبلغ، اطلاعات دریافت‌کننده و زمان موردنیاز بررسی می‌شود.",
