...
const fa: Dictionary = {
  ...
  nav: [
    { label: "خانه", href: "/" },
    {
      ...
      children: [
        ...
        { label: "حواله یوآن چین", href: "/services/yuan-transfer", description: "پرداخت RMB برای سفارش‌های وارداتی و خرید از چین" },
  ...
  footer: { intro: "برند خدمات بازرگانی، آموزش تجارت خارجی، ترخیص کالا و اسناد کاربردی واردات و صادرات.", address: "تهران، منطقه 3، آفریقا (جردن)، بالاتر از خیابان اسفندیار، خیابان انصاری (صداقت)، پلاک 1، واحد 1 غربی", pages: "صفحات", mainServices: "خدمات اصلی", contactSocial: "ارتباط و شبکه‌های اجتماعی", rights: "تمام حقوق مادی و معنوی این وب‌سایت برای خوبروز محفوظ است." },
  home: {
