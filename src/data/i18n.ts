...
const fa: Dictionary = {
  ...
  nav: [
    { label: "خدمات", href: "/services", children: [
    ...
    { label: "واردات از چین", href: "/import-from-china", children: [
    ...
    { label: "حواله‌های ارزی", href: "/currency-transfer", children: [
    ...
    { label: "دانشنامه تجاری", href: "/trade-encyclopedia", children: [
    ...
    { label: "اخبار و بخشنامه‌ها", href: "/trade-updates", children: [
    ...
    { label: "ارتباط با خوبروز", href: "/contact", children: [
  ...
  footer: { intro: "برند خدمات بازرگانی، آموزش تجارت خارجی، ترخیص کالا و اسناد کاربردی واردات و صادرات.", address: "تهران، بلوار آفریقا (جردن)، بالاتر از خیابان اسفندیار، خیابان انصاری (صداقت)، پلاک 1", pages: "صفحات", mainServices: "خدمات اصلی", contactSocial: "ارتباط و شبکه‌های اجتماعی", rights: "تمام حقوق مادی و معنوی این وب‌سایت برای خوبروز محفوظ است." },
  home: {
    ...
    hero: { eyebrow: "خدمات بازرگانی، واردات، صادرات و ترخیص کالا", title: "اینجا، مسیر تجارت روشن است.", description: "بررسی خدمات بازرگانی، ترخیص و اسناد تجاری.", consult: "دریافت مشاوره", services: "مشاهده خدمات", customsConsult: "مشاوره امور گمرکی" },
  ...
  services: [
    ...
    { title: "حواله یوآن چین", description: "بررسی مسیر پرداخت یوآن چین برای سفارش‌های وارداتی، خرید از تامین‌کننده و هماهنگی پرداخت RMB.", href: "/services/yuan-transfer", eyebrow: "پرداخت چین", cta: "بررسی حواله" },
...
const en: Dictionary = {
  ...
  nav: [
    ...
    { label: "Services", href: "/services", children: [
      ...
      { label: "China yuan transfer", href: "/services/yuan-transfer", description: "RMB payment coordination for import orders and China purchases" },
  ...
  services: [
    ...
    { title: "China yuan transfer", description: "Review RMB payment coordination for import orders, supplier payments, and China purchase settlements.", href: "/services/yuan-transfer", eyebrow: "China payment", cta: "Review transfer" },
  ...
  const common = {
    ar: {
      ...
      services: [
        ...
        ["حوالة اليوان الصيني", "مراجعة مسار دفع RMB للطلبات التجارية والمشتريات من الصين.", "دفع الصين", "مراجعة الحوالة"],
    ...
    ru: {
      ...
      services: [
        ...
        ["Перевод юаней в Китай", "Проверка RMB-платежа для импортных заказов и закупок в Китае.", "Платеж Китай", "Проверить перевод"],
    ...
    zh: {
      ...
      services: [
        ...
        ["人民币汇款", "为进口订单和中国采购审核 RMB 支付路径。", "中国支付", "审核汇款"],
    ...
    tr: {
      ...
      services: [
        ...
        ["Çin yuan transferi", "İthalat siparişleri ve Çin alımları için RMB ödeme yolunun incelenmesi.", "Çin ödemesi", "Transferi incele"],
