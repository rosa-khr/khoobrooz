...
class TgjuMarketRateService
{
    ...
    private const DEFINITIONS = [
        ...
        ['key' => 'ice_transfer_usd_sell', 'title' => 'حواله تجاری دلار', 'symbol' => 'USD', 'unit' => 'ریال', 'group' => 'commercialTransfer', 'sort_order' => 80],
        ['key' => 'ice_transfer_eur_sell', 'title' => 'حواله تجاری یورو', 'symbol' => 'EUR', 'unit' => 'ریال', 'group' => 'commercialTransfer', 'sort_order' => 90],
        ['key' => 'ice_transfer_aed_sell', 'title' => 'حواله تجاری درهم', 'symbol' => 'AED', 'unit' => 'ریال', 'group' => 'commercialTransfer', 'sort_order' => 100],
        ['key' => 'ice_transfer_cny_sell', 'title' => 'حواله تجاری یوان', 'symbol' => 'CNY', 'unit' => 'ریال', 'group' => 'commercialTransfer', 'sort_order' => 110],
        ['key' => 'ice_transfer_rub_sell', 'title' => 'حواله تجاری روبل', 'symbol' => 'RUB', 'unit' => 'ریال', 'group' => 'commercialTransfer', 'sort_order' => 120],
        ['key' => 'geram18', 'title' => 'طلای ۱۸ عیار', 'symbol' => '18K', 'unit' => 'ریال', 'group' => 'metal', 'sort_order' => 210],
        ['key' => 'geram24', 'title' => 'طلای ۲۴ عیار', 'symbol' => '24K', 'unit' => 'ریال', 'group' => 'metal', 'sort_order' => 220],
        ['key' => 'mesghal', 'title' => 'مثقال طلا', 'symbol' => 'MITHQAL', 'unit' => 'ریال', 'group' => 'metal', 'sort_order' => 230],
        ['key' => 'sekee', 'title' => 'سکه امامی', 'symbol' => 'Emami', 'unit' => 'ریال', 'group' => 'coin', 'sort_order' => 310],
        ['key' => 'sekeb', 'title' => 'سکه بهار آزادی', 'symbol' => 'Bahar', 'unit' => 'ریال', 'group' => 'coin', 'sort_order' => 320],
        ['key' => 'nim', 'title' => 'نیم سکه', 'symbol' => '1/2', 'unit' => 'ریال', 'group' => 'coin', 'sort_order' => 330],
        ['key' => 'rob', 'title' => 'ربع سکه', 'symbol' => '1/4', 'unit' => 'ریال', 'group' => 'coin', 'sort_order' => 340],
        ['key' => 'gerami', 'title' => 'سکه گرمی', 'symbol' => '1g', 'unit' => 'ریال', 'group' => 'coin', 'sort_order' => 350],
    ];
