...
INSERT INTO tmp_content_menus (title, url, slug, parent_slug, level, sort_order, seo_title, seo_description) VALUES
  ...
  ('اخبار تجارت', '/trade-news', 'trade-news-menu', NULL, 1, 60, 'اخبار تجارت | خوبروز', 'اخبار گمرک، واردات، صادرات، ارز، چین و تجارت خارجی.'),
  ('اخبار گمرک', '/trade-news/customs-news', 'trade-news-customs-menu', 'trade-news-menu', 2, 61, 'اخبار گمرک | خوبروز', 'خبرهای گمرکی، تغییر رویه‌ها و موضوعات اجرایی گمرک.'),
  ('اخبار واردات', '/trade-news/import-news', 'trade-news-import-menu', 'trade-news-menu', 2, 62, 'اخبار واردات | خوبروز', 'خبرهای واردات کالا، ثبت سفارش و تصمیم‌های مرتبط با واردات.'),
  ('اخبار صادرات', '/trade-news/export-news', 'trade-news-export-menu', 'trade-news-menu', 2, 63, 'اخبار صادرات | خوبروز', 'خبرهای صادرات کالا، بازارهای هدف و سیاست‌های صادرات.'),
  ('تجارت با چین', '/trade-news/china-trade', 'trade-news-china-trade-menu', 'trade-news-menu', 2, 64, 'اخبار تجارت با چین | خوبروز', 'خبرهای تجارت ایران و چین، واردات از چین و مسیرهای تجاری مرتبط.'),
  ('تجارت با اوراسیا', '/trade-news/eurasia-trade', 'trade-news-eurasia-trade-menu', 'trade-news-menu', 2, 65, 'اخبار تجارت با اوراسیا | خوبروز', 'خبرهای تجارت با اتحادیه اقتصادی اوراسیا و تعرفه‌های منطقه‌ای.'),
  ('تجارت آسیا', '/trade-news/asia-trade', 'trade-news-asia-trade-menu', 'trade-news-menu', 2, 66, 'اخبار تجارت آسیا | خوبروز', 'خبرهای تجارت با کشورهای آسیایی و بازارهای منطقه‌ای.'),
  ('حمل و لجستیک', '/trade-news/shipping-logistics', 'trade-news-shipping-logistics-menu', 'trade-news-menu', 2, 67, 'اخبار حمل‌ونقل و لجستیک | خوبروز', 'خبرهای حمل بین‌المللی، لجستیک، زنجیره تامین و مسیرهای حمل کالا.'),
  ('بخشنامه‌های گمرکی', '/trade-circulars/customs-circulars', 'customs-circulars-menu', NULL, 1, 70, 'بخشنامه‌های گمرکی | خوبروز', 'بخشنامه‌ها و ابلاغیه‌های رسمی گمرکی.'),
