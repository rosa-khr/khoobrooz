...
Copy `infra/nginx/khoobrooz.conf.example`, replace the domain, enable the site, and issue a TLS certificate before public access. Basic Auth credentials must only travel over HTTPS.
